                                                ...
                                                <table class="table table-bordered">
                                                    <tr>
                                                        ...
                                                        <td class="imgcol{{$img->id}}"> 
                                                            <img width="100px" src="{{asset('storage/app/'.$img->img_src)}}"/>
                                                             <p>
                                <button type="button" class="btn btn-danger btn-sm delete-image" data-image-id="{{$img->id}}" onclick=" return confirm('Are You Sure You Want to Delete?')"><i class="fa fa-trash"></i></button>
                                                            </p>
